...
public class UserServiceServiceLocator extends org.apache.axis.client.Service implements localhost.wsddorg.services.UserService.UserServiceService {
    ...
    private java.lang.String UserService_address = "http://localhost:8080/wsddorg/services/UserService";
    ...
    public localhost.wsddorg.services.UserService.UserService getUserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.wsddorg.services.UserService.UserServiceSoapBindingStub _stub = new localhost.wsddorg.services.UserService.UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.wsddorg.services.UserService.UserService.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.wsddorg.services.UserService.UserServiceSoapBindingStub _stub = new localhost.wsddorg.services.UserService.UserServiceSoapBindingStub(new java.net.URL(UserService_address), this);
                _stub.setPortName(getUserServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/wsddorg/services/UserService", "UserServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:8080/wsddorg/services/UserService", "UserService"));
        }
