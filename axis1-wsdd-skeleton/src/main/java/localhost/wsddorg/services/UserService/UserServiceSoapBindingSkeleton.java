...
public class UserServiceSoapBindingSkeleton implements localhost.wsddorg.services.UserService.UserService, org.apache.axis.wsdl.Skeleton {
    private localhost.wsddorg.services.UserService.UserService impl;
    ...
    */
    ...
    public UserServiceSoapBindingSkeleton() {
        this.impl = new localhost.wsddorg.services.UserService.UserServiceSoapBindingImpl();
    }

    public UserServiceSoapBindingSkeleton(localhost.wsddorg.services.UserService.UserService impl) {
        this.impl = impl;
    }
