...
public class UserServiceLocator extends org.apache.axis.client.Service implements UserService {
    ...
    public UserServiceImpl getUserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            UserServiceImplSoapBindingStub _stub = new UserServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (UserServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                UserServiceImplSoapBindingStub _stub = new UserServiceImplSoapBindingStub(new java.net.URL(UserService_address), this);
                _stub.setPortName(getUserServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:8080/wsddorg/services/UserService", "UserService");
    }
