...
public class UserServiceServiceLocator extends org.apache.axis.client.Service implements com.xumiao.ws.client.UserServiceService {
    ...
    private java.lang.String UserService_address = "http://localhost:8080/wsddske/services/UserService";
    ...
    public com.xumiao.ws.client.UserService_PortType getUserService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.xumiao.ws.client.UserServiceSoapBindingStub _stub = new com.xumiao.ws.client.UserServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.xumiao.ws.client.UserService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.xumiao.ws.client.UserServiceSoapBindingStub _stub = new com.xumiao.ws.client.UserServiceSoapBindingStub(new java.net.URL(UserService_address), this);
                _stub.setPortName(getUserServiceWSDDServiceName());
                return _stub;
            }
        }
