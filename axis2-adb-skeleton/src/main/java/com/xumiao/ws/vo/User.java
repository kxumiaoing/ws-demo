...
public class User implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = User
       Namespace URI = http://localhost:8080/ws/vo
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"User".equals(type)) {
                            ...
                            return (User) com.xumiao.ws.vo.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://localhost:8080/ws/vo", "age").equals(
                            reader.getName())) ||
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://localhost:8080/ws/vo", "name").equals(
                            reader.getName())) ||
