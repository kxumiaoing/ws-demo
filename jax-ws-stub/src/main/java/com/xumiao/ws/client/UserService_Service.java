 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://localhost:8080/ws/services", wsdlLocation = "http://localhost:8080/jaxservlet/services/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://localhost:8080/ws/services", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxservlet/services/UserService?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://localhost:8080/ws/services", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8080/ws/services", "UserServiceImplPort"), UserService.class, features);
    }
